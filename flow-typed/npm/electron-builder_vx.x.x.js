// flow-typed signature: 52fc3be05ae5c2b4718bcc2aca87ab76
// flow-typed version: <<STUB>>/electron-builder_v19.45.1/flow_v0.58.0
...
declare module 'electron-builder/out/options/CommonWindowsInstallerConfiguration' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/targets/AppImageTarget' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/targets/nsis/NsisTarget' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/vm/MonoVm' {
  declare module.exports: any;
}

declare module 'electron-builder/out/vm/ParallelsVm' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/vm/WineVm' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/options/CommonWindowsInstallerConfiguration.js' {
  declare module.exports: $Exports<'electron-builder/out/options/CommonWindowsInstallerConfiguration'>;
}
...
declare module 'electron-builder/out/targets/AppImageTarget.js' {
  declare module.exports: $Exports<'electron-builder/out/targets/AppImageTarget'>;
}
...
declare module 'electron-builder/out/targets/nsis/NsisTarget.js' {
  declare module.exports: $Exports<'electron-builder/out/targets/nsis/NsisTarget'>;
}
...
declare module 'electron-builder/out/vm/MonoVm.js' {
  declare module.exports: $Exports<'electron-builder/out/vm/MonoVm'>;
}
declare module 'electron-builder/out/vm/ParallelsVm.js' {
  declare module.exports: $Exports<'electron-builder/out/vm/ParallelsVm'>;
}
declare module 'electron-builder/out/vm/vm.js' {
  declare module.exports: $Exports<'electron-builder/out/vm/vm'>;
}
declare module 'electron-builder/out/vm/WineVm.js' {
  declare module.exports: $Exports<'electron-builder/out/vm/WineVm'>;
}
