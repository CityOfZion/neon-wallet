  ...
  return (
    <div
      ...
      className={StyleHelper.mergeStyles(
        'group flex items-center w-full border text-center rounded py-3 gap-x-2.5 cursor-pointer transition-colors aria-[disabled=false]:hover:bg-gray-200/15 aria-[disabled=true]:opacity-50 aria-[disabled=true]:cursor-not-allowed',
        {
