...
test.serial('should show wallet passphrase', async t => {
  t.true(await app.client.isVisible('#newWallet .keyListItem:nth-child(0) .key'))
  const passphraseText = await app.client.getText('#newWallet .keyListItem:nth-child(0) .key')
