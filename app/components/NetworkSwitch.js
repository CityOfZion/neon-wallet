...
export const getMarketPriceUSD = amount => axios.get('https://bittrex.com/api/v1.1/public/getticker?market=USDT-NEO').then((response) => {
  console.log(response);
  const lastUSDNEO = Number(response.data.result.Last);
