...
const MIGRATE_WALLETS_NEON3_STEPS = {
  ...
  migrateWalletsNeon3Step1Description:
    'Bắt đầu bằng cách tải xuống bản dựng NEON mới nhất và tạo ví đầu tiên của bạn:',
  migrateWalletsNeon3Step1DownloadButton: 'Tải xuống ví NEON mới',
  migrateWalletsNeon3Step1NextStep:
    'Sau khi phiên bản mới của NEON được cài đặt trên thiết bị của bạn, hãy chuyển sang bước tiếp theo.',
  ...
  migrateWalletsNeon3Step2Description:
    'Lưu tệp di chuyển NEON cũ vào máy tính của bạn. Bạn sẽ sử dụng tệp này để di chuyển ví của mình vào phiên bản mới của NEON.',
  ...
  migrateWalletsNeon3Step2NextStep:
    'Khi bạn đã xác định vị trí để lưu tệp di chuyển, hãy chuyển sang bước tiếp theo.',
  ...
  migrateWalletsNeon3Step3Description2:
    'Để hoàn tất quá trình di chuyển, hãy mở ví NEON mới và làm theo hướng dẫn.',
...
const MIGRATE_WALLETS_NEON3_NOTICE = {
  migrateWalletsNeon3NoticeTitle:
    'Bạn có muốn di chuyển ví hiện tại của mình sang phiên bản mới nhất của NEON không?',
  migrateWalletsNeon3NoticeSubtitle: 'Di chuyển ví của bạn thật dễ dàng!',
  migrateWalletsNeon3NoticeDescription:
    'Nó sẽ cung cấp cho bạn quyền truy cập vào nhiều loại tài sản, tính năng và mạng được hỗ trợ hơn, đồng thời cung cấp trải nghiệm người dùng gọn gàng hơn, được cải thiện để quản lý tài sản của bạn trở nên dễ dàng hơn!',
  migrateWalletsNeon3NoticeButtonLabel: 'Di chuyển ngay bây giờ!',
  migrateWalletsNeon3NoticeNote:
    'Lưu ý: Bạn vẫn sẽ giữ quyền truy cập vào phiên bản Neon này!',
}
