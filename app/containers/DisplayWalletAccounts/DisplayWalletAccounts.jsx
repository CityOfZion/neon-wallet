    ...
    return (
      <div id="newWallet">
        <div className="disclaimer">
          You must save and backup the keys below. If you lose them, you lose
          access to your assets. You can click "Save Key" to save the encrypted
          key in local application storage. Verify that you can log in to the
          account and see the correct public address before sending anything to
          the address below!
        </div>
        ...
        <div className="saveAccount">
          ...
          />
          <Button onClick={() => saveAccount(keyName, address, encryptedWIF)}>
            Save Account
          </Button>
        </div>
