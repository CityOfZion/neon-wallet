...
export default (state = {
  wif: null, address: null, passphrase: null, encryptedWif: null, generating: false,
}, action) => {
  switch (action.type) {
    case NEW_WALLET_KEYS:
      ...
      return {
        ...state, wif: newWif, address: loadAccount.address, passphrase: action.passphrase, encryptedWif,
      };
    case NEW_WALLET:
      return {
        ...state, wif: action.wif, address: action.address, passphrase: action.passphrase, encryptedWif: action.encryptedWif, generating: false,
      };
    case SET_GENERATING:
