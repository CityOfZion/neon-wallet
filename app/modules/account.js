...
export default (state = {
  wif: null, address: null, loggedIn: false, redirectUrl: null, decrypting: false, accountKeys: [],
}, action) => {
  switch (action.type) {
    case LOGIN:
      let loadAccount;
      ...
      return {
        ...state, wif: action.wif, address: loadAccount.address, loggedIn: true, decrypting: false,
      };
    case LOGOUT:
      return {
        ...state, wif: null, address: null, loggedIn: false, decrypting: false,
      };
    case SET_DECRYPTING:
