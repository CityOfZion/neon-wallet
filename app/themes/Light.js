...
export var LIGHT_NETWORK_CONFIG_TOOLTIP = {
...
export default __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, NEWS), AMOUNTS_PANEL), NODE_SELECT), MODAL), AUTH_STYLES), BASE), BUTTON), INPUT), PANEL), TAB), DASHBOARD), SIDEBAR), TX_LIST), SETTINGS), HEADER_BAR), CONTACTS), SEND), QR_SCANNER), LIGHT_NETWORK_CONFIG_TOOLTIP), NOTIFICATIONS), RELEASE_NOTES), MOBILE);
