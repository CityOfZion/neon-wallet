...
/**
 * Returns an object containing the balances of the specified address on the specified network.
 * The object has keys for each asset, with the values being the balance of that asset.
 * If the address has no balance for an asset, the value for that asset will be '0'.
 * @param {Object} props - An object containing the network and address to get the balances for.
 * @returns {Object.<string, (string|Object.<string, *>)}>} An object containing the balances of the specified address on the specified network.
 */
 ...
 * @returns {Object.<string, (string|Object.<string, *>)}>} An object containing the balances of the specified address on the specified network.
 */
async function getN3Balances({ net, address }: Props): Promise<Object> {
  const balances = {
    NEO: 0,
    GAS: 0,
  }
